...
totald <- sum(dane_popul$x[dane_popul$id == 15])
...
## zmiennej y w domenie 15 odchylają się od jego wartości oczekiwanej 
## przeciętnie o 70377,9
...
## INTERPRETACJA
## Ocena średniego błędu szacunku estymatora stanowi 36,29% wartości estymatora
## wartości średniej zmiennej y w domenie 15.
