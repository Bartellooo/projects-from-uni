...
eD2.e_estCAL_srd<-(1/Nd^2)*calibev(ysd,Xs,total,PI,d,g,with=TRUE)$evar
eD.e_estCAL_srd<-sqrt(eD2.e_estCAL_srd)
egamma.e_estCAL_srd<-100*eD.e_estCAL_srd/estCAL_srd
...
## przeciętnie o 2444,009.

# wartość estymatora względnego p-średniego błędu szacunku estymatora
egamma.e_estCAL_srd

## INTERPRETACJA
## Ocena średniego błędu szacunku estymatora stanowi 42,66% wartości estymatora
...
eD2.e_estCAL_wgd<-calibev(ysd,Xs,total,PI,d,g,with=TRUE)$evar
eD.e_estCAL_wgd<-sqrt(eD2.e_estCAL_wgd)
egamma.e_estCAL_wgd<-100*eD.e_estCAL_wgd/estCAL_wgd
